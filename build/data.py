...
CATEGORIES = [
    {
        ...
        "ritual": "Sabon beldi is bedoeld als zachte voorbereiding voor het scrubben. Eerst sabon beldi insmeren, vervolgens in laten werken, afspoelen en afsluitend scrubben met een kessa.",
    ...
    },
    {
        ...
        "tip": None,
        "body": [
            'Hammamkruiden bestaat uit traditionele kruidenblends voor lichaam en haar die je met water aanmaakt tot een papje. Het is een authentiek onderdeel van de Marokkaanse hammambeleving. CALMMINI biedt een blend voor het lichaam en een blend voor hoofdhuid en haar.',
        ...
        "seo_title": "Hammamkruiden kopen - hammamkruiden voor lichaam en haar | CALMMINI",
        "seo_desc": "Hammamkruiden: traditionele hammamkruiden voor lichaam en haar, aan te maken "
                    "met water tot een papje. Voor een authentiek Marokkaans hammamritueel.",
    },
    {
        "slug": "verzorgingsolien",
        "name": "Verzorgingsoliën",
        "menu": "Verzorgingsoliën",
        "tagline": "Plantaardige oliën, 100 ml",
        "intro": "Plantaardige oliën voor huid, haarpunten, massage en droge zones. "
                 "Gebruik weinig: enkele druppels zijn meestal genoeg.",
        "tip": "Bewaar oliën goed afgesloten, koel en uit direct zonlicht. Zo blijven geur, "
               "textuur en kwaliteit langer mooi.",
        "body": [
            'Onze verzorgingsolien zijn lichte, plantaardige oliën (100 ml) voor huid, haarpunten, massage en droge zones. Ze sluiten het hammamritueel af en verzorgen de huid zonder zwaar gevoel. Kies uit saffloer-, amandel-, abrikozenpit- en aloe vera olie.',
            'Gebruik weinig: enkele druppels op een licht vochtige huid of droge plekken zijn meestal genoeg. Bewaar de oliën koel, droog en uit direct zonlicht. Natuurlijke Marokkaans geinspireerde verzorging, bezorgd in heel Nederland.',
        ],
        "faq": [
        ...
        "seo_title": "Verzorgingsoliën kopen - plantaardige oliën 100 ml | CALMMINI",
...
PRODUCTS = [
    # 1. Sabon Beldi
    P("sabon-beldi-naturel", "Sabon Beldi Naturel", "sabon-beldi", 11.95,
      ...
      badge="Bestseller"),
    P("sabon-beldi-nila", "Sabon Beldi Nila", "sabon-beldi", 13.95,
    ...
    P("sabon-beldi-eucalyptus", "Sabon Beldi Eucalyptus", "sabon-beldi", 13.95,
    ...
    P("sabon-beldi-musk", "Sabon Beldi Musk", "sabon-beldi", 13.95,
    ...
    P("sabon-beldi-aker-fassi", "Sabon Beldi Aker Fassi", "sabon-beldi", 13.95,
    ...
    # 2. Ghassoul & Klei
    P("groene-klei", "Groene Klei", "ghassoul-klei", 17.95,
      ...
      badge="Bestseller"),
    P("rode-klei", "Rode Klei", "ghassoul-klei", 17.95,
    ...
    P("ghassoul-roos", "Ghassoul Rose", "ghassoul-klei", 13.95,
      ...
      badge="Bestseller"),
    P("ghassoul-oranjebloesem", "Ghassoul Orange Blossom", "ghassoul-klei", 13.95,
    ...
    # 3. Hammamkruiden
    P("hammamkruiden-lichaam", "Hammamkruiden Lichaam", "hammampoeder", 11.95,
      ...
      badge="Bestseller"),
    P("hammamkruiden-haar", "Hammamkruiden Haar", "hammampoeder", 11.95,
    ...
    # 4. Verzorgingsoliën
    P("saffloerolie", "Saffloerolie", "verzorgingsolien", 18.95,
      ...
      inhoud="100 ml"),
    P("amandelolie", "Amandelolie", "verzorgingsolien", 10.95,
      ...
      inhoud="100 ml"),
    P("abrikozenpitolie", "Abrikozenpitolie", "verzorgingsolien", 10.95,
      ...
      inhoud="100 ml"),
    P("aloe-vera-olie", "Aloe Vera Olie", "verzorgingsolien", 16.95,
    ...
    # 5. Butter & Scrub
    P("shea-butter", "Shea Butter", "butter-scrub", 13.95,
      ...
      badge="Bestseller"),
    P("mediterraanse-scrub", "Mediterraanse Scrub", "butter-scrub", 18.95,
    ...
    # 6. Accessoires
    P("kessa", "Kessa Scrubhandschoen", "accessoires", 4.00,
...
BLOG = [
    {
        ...
        "seo_desc": "Zo doe je een Marokkaans hammamritueel thuis: van sabon beldi en gommage tot "
                    "ghassoul, kruiden en oliën. De complete stap-voor-stap gids van CALMMINI.",
        "date": "2025-11-04",
        "read": 7,
    ...
    },
    {
        ...
        "excerpt": "Van hammamkruiden tot oliën: een introductie in natuurlijke haarverzorging volgens "
        ...
        "body": [
            ...
            ("p", "In de Marokkaanse verzorgingscultuur speelt natuurlijke haarverzorging een belangrijke rol. "
                  "Kruiden, klei en oliën worden al generaties lang ingezet als onderdeel van het ritueel."),
            ("h2", "Waar begin je?"),
...
# "Goed om te weten" per product (uit het productoverzicht van CALMMINI)
EXTRA_INFO = {
    "sabon-beldi-naturel": "Niet in de ogen gebruiken en niet op wondjes of geïrriteerde huid. Hydrateer na gebruik met olie of shea butter.",
    "sabon-beldi-nila": "Nila kan kleur afgeven — rustig doseren en eerst testen op een klein stukje huid. Op het gezicht alleen voorzichtig gebruiken.",
    "sabon-beldi-eucalyptus": "Kan sterker ruiken en prikkelender aanvoelen dan naturel. Niet gebruiken bij een zeer gevoelige huid of rond de ogen.",
    "sabon-beldi-musk": "Bij parfumgevoeligheid eerst testen. Niet gebruiken op een geïrriteerde huid.",
    "sabon-beldi-aker-fassi": "Kan kleur afgeven — pas op met lichte handdoeken, witte kleding en voegen in de badkamer. Eerst testen.",
    "groene-klei": "Niet elke dag gebruiken. Bij een droge of gevoelige huid korter laten zitten en daarna altijd hydrateren.",
    "rode-klei": "Kan kleur afgeven — voorzichtig met witte handdoeken. Niet gebruiken op een kapotte huid.",
    "ghassoul-roos": "Laat ghassoul niet te lang uitdrogen op het gezicht. In het haar goed uitspoelen.",
    "ghassoul-oranjebloesem": "Niet laten uitdrogen tot het gaat trekken. Bij een gevoelige huid eerst testen.",
    "saffloerolie": "Bij een allergie voor zaden of planten eerst testen. Gebruik weinig — olie werkt het mooist in een kleine hoeveelheid.",
    "amandelolie": "Niet geschikt bij een notenallergie. Kan voor sommige gezichten te rijk zijn; bij een acnegevoelige huid voorzichtig gebruiken.",
    "abrikozenpitolie": "Begin met een kleine hoeveelheid. Bij een gevoelige huid eerst testen.",
    "aloe-vera-olie": "Bedoeld als verzorgende, verzachtende olie — geen medisch product tegen verbranding of huidaandoeningen.",
    "shea-butter": "Rijk en vet — voor het gezicht weinig gebruiken, zeker bij een vette of acnegevoelige huid.",
    "mediterraanse-scrub": "Niet te hard scrubben en niet gebruiken op wondjes, pas geschoren of geïrriteerde huid. 1 à 2 keer per week is meestal genoeg.",
    "kessa": "Niet te hard drukken. Niet gebruiken op gezicht, wondjes, huiduitslag of net geschoren huid. Na gebruik goed uitspoelen en laten drogen.",
    "puimsteen": "Niet gebruiken op wondjes, kloven, geïrriteerde huid of het gezicht. Bij diabetes of een slechte doorbloeding voorzichtig zijn — een medisch pedicure is dan veiliger.",
}
