...
- **Bestellingen & contact per e-mail** — bestellingen en contactberichten
  komen per e-mail binnen (geen online betaling). Instellen: zie
  `bestellingen-per-mail/LEES-MIJ.md` en vul je Web3Forms-sleutel in bij
  `FORM_KEY` boven in `assets/js/app.js`.
